<?php
header("Access-Control-Allow-Origin: http://localhost:5173"); // ระบุพอร์ตของ React ให้ชัดเจน
header("Access-Control-Allow-Credentials: true"); // อนุญาตให้รับส่ง Cookie/Session ได้
