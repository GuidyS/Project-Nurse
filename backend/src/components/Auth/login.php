...
try {
    ...
    if ($user && password_verify($password, $user['password_hash'])) {
        ...
        // ✅ FIX: ตัดการ insert audit_log ประเภท 'login' ออก (ตามที่ตัดสินใจแล้วว่าไม่ต้องเก็บ
        // เข้า/ออกระบบเข้า audit_log อีกต่อไป — ใช้ logAudit() เฉพาะ create/update/delete/role_change แทน)
