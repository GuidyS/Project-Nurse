...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $teamwork = isset($scores['teamwork'][0]) ? (float)$scores['teamwork'][0] : 0.0;
    $punctuality = isset($scores['punctuality'][0]) ? (float)$scores['punctuality'][0] : 0.0;

    $overall = ($skill + $attitude + $knowledge + $communication + $teamwork + $punctuality) / 6;
