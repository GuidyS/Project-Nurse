...
$positionIds = array_map('intval', $positionStmt->fetchAll(PDO::FETCH_COLUMN) ?: []);
...
$canViewResearchSummary = $roleId === 2 && (
    in_array(1, $positionIds, true) ||
    in_array(9, $positionIds, true) ||
    in_array('RESEARCH_SUMMARY_VIEW', $permissions, true)
);

if (!$canViewResearchSummary) {
