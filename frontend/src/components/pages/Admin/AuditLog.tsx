...
export default function AuditLog() {
  ...
  const filteredLogs = logs.filter((entry) => {
    ...
    const matchesResource =
      resourceFilter === "all" ||
      (resourceFilter === "project_approval" && entry.resource === "การอนุมัติโครงการ") ||
      entry.resource === resourceFilter;
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Select value={resourceFilter} onValueChange={setResourceFilter}>
                  ...
                  <SelectContent>
                    <SelectItem value="all">ทุกประเภทข้อมูล</SelectItem>
                    <SelectItem value="project_approval">การอนุมัติโครงการ</SelectItem>
                    <SelectItem value="ระบบ">ระบบ</SelectItem>
                  </SelectContent>
                </Select>
