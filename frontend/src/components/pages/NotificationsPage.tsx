...
/**
 * NotificationsPage Component - หน้าการแจ้งเตือน
 * 
 * หน้าที่:
 * - แสดงรายการการแจ้งเตือนทั้งหมด
 * - ส่งการแจ้งเตือนใหม่ให้นักศึกษา
 * - จัดการการแจ้งเตือน (อ่าน, ลบ, กรอง)
 * - แสดงสถิติการแจ้งเตือน
 * 
 * Features:
 * - Tabs สำหรับกรองการแจ้งเตือน (ทั้งหมด, ยังไม่อ่าน, คำขอ, ที่ส่งแล้ว)
 * - Dialog สำหรับส่งการแจ้งเตือนใหม่
 * - รองรับหลายช่องทาง (In-App, Email, ทั้งสอง)
 * - แสดง badge และ icon ตามประเภทการแจ้งเตือน
 */
const NotificationsPage = () => {
  ...
  /**
   * unreadCount - นับจำนวนการแจ้งเตือนที่ยังไม่อ่าน
   */
  const unreadCount = notifications.filter((n) => !n.isRead).length;
  
  /**
   * requestCount - นับจำนวนคำขอนัดพบที่ยังไม่อ่าน
   */
  const requestCount = notifications.filter((n) => n.type === "request" && !n.isRead).length;

  /**
   * getTypeIcon - สร้าง Icon component ตามประเภทการแจ้งเตือน
   * 
   * @param {Notification["type"]} type - ประเภทการแจ้งเตือน
  ...
  /**
   * getTypeBadge - สร้าง Badge component ตามประเภทการแจ้งเตือน
   * 
   * @param {Notification["type"]} type - ประเภทการแจ้งเตือน
  ...
  /**
   * getChannelBadge - สร้าง Badge component ตามช่องทางการส่ง
   * 
   * @param {Notification["channel"]} channel - ช่องทางการส่ง
   * @returns {JSX.Element} - Badge component
   */
  ...
  /**
   * markAsRead - ทำเครื่องหมายว่าการแจ้งเตือนถูกอ่านแล้ว
   * 
  ...
  /**
   * markAllAsRead - ทำเครื่องหมายว่าการแจ้งเตือนทั้งหมดถูกอ่านแล้ว
   * 
   * หน้าที่:
   * - อัพเดท isRead ของทุกการแจ้งเตือนเป็น true
   ...
   * 
   * @param {number} id - ID ของการแจ้งเตือนที่ต้องการลบ
   */
  ...
  /**
   * toggleStudent - สลับการเลือกนักศึกษา (เลือก/ยกเลิก)
   * 
  ...
  /**
   * selectAllStudents - เลือก/ยกเลิกเลือกนักศึกษาทั้งหมด
   * 
   * หน้าที่:
   * - ถ้าเลือกทั้งหมดอยู่แล้ว → ยกเลิกทั้งหมด
   * - ถ้ายังไม่เลือกทั้งหมด → เลือกทั้งหมด
   */
  ...
  /**
   * sendNotification - ส่งการแจ้งเตือนใหม่
   * 
   * หน้าที่:
   * - ตรวจสอบว่าข้อมูลครบถ้วน (หัวข้อ, เนื้อหา, เลือกนักศึกษา)
   * - สร้าง notification object ใหม่
   * - เพิ่มเข้า notifications list
   * - รีเซ็ต form และปิด dialog
   * - แสดง toast notification
   */
  ...
  /**
   * filteredNotifications - กรองการแจ้งเตือนตาม tab ที่เลือก
   * 
   * @param {string} tab - ชื่อ tab (all, unread, requests, sent)
   * @returns {Notification[]} - Array ของการแจ้งเตือนที่กรองแล้ว
   */
