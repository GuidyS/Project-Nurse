              ...
              <Card key={project.id}>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex gap-2">
                    <Button variant="outline" onClick={() => onItemClick?.("project-docs")}>จัดการเอกสาร</Button>
                    <Button variant="outline" onClick={() => onItemClick?.("project-links")}>เชื่อมโยง PLO/YLO/CLO</Button>
                    <Button onClick={() => onItemClick?.("project-reports")}>ดูรายละเอียด</Button>
                  </div>
                </CardContent>
              </Card>
            ))}
